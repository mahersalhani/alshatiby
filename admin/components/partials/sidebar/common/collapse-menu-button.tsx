...
export function CollapseMenuButton({ icon, label, active, submenus, collapsed, id }: CollapseMenuButtonProps) {
  ...
  const sidebarTheme =
    config.sidebarTheme !== 'light' ? `dark theme-${config.sidebarTheme}` : `theme-${config.sidebarTheme}`;
