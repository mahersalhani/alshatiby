...
import { useStudentQuery } from '@/hooks/react-query/student';
...
const StudentDataTable = () => {
  ...
  const { data, isLoading } = useStudentQuery(query);
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-4 px-5">
        <div className="flex-1 text-xl font-medium text-default-900">{t('student.list_title')}</div>
