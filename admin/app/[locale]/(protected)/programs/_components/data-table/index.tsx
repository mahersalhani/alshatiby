...
import { useProgramQuery } from '@/hooks/react-query/program';
...
export function ProgramsDataTable() {
  ...
  const { data, isLoading } = useProgramQuery(query);
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-4 px-5">
        <div className="flex-1 text-xl font-medium text-default-900">{t('programs.list_title')}</div>
